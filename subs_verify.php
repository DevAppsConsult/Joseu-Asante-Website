...
<head>
	...
	<title>About Author | Josey</title>
								...
								<div id="tg-navigation" class="collapse navbar-collapse tg-navigation">
									<ul>
										...
										<li class="current-menu-item">
											<a href="authordetail.html">About Author</a>
										</li>
										<li><a href="contactus.html">Contact Author</a></li>
										<li>
											<a href="products.html">Articles</a>
										</li>
									</ul>
								</div>
							</nav>
			...
			<div class="tg-sectionspace tg-haslayout">
                ...
                <div class="col-md-offset-3 col-md-6">
                  <div class="form-group">
                    <label>Subscribtion verification Code</label>
							...
							<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
								<div class="tg-footercol tg-widget tg-widgetnavigation">
									...
									<div class="tg-widgetcontent">
										...
										<ul>
											<li><a href="javascript:void(0);">About Author</a></li>
									...
									<div class="tg-widgetcontent">
										<ul>
											<li>
												...
												<div class="tg-authornameArticles">
													<h4><a href="javascript:void(0);">Jude Morphew</a></h4>
													<p>21,658 Published Articles</p>
												</div>
											</li>
											<li>
				...
				<div class="container">
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<span class="tg-copyright">2018 All Rights Reserved By &copy; josey</span>
						</div>
					</div>
				</div>
			</div>

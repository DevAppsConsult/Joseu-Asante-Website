...
class DateCombo
{
    ...
    public $Comment;
    public $NamePrefix;
    public $CSSOptionClass;
    public $CSSSelectedClass;
    public $CSSCommentClass;
    ...
    public function GetHTML($readOnly=false)
    {
        ...
        for ($i = 0; $i < 3; $i++) {
            ...
            if ($i == 2) {
                $editable_date .= '<td style="width: 4em;"><button class="btn btn-default btn-block" id="fd-but-' . $this->NamePrefix . '"><i class="glyphicon glyphicon-th"></i></button></td>';
            }
        }

            ...
            ?>
                ...
                ?>
                    ...
                    ?>
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][5]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][5]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo $Translation['ImageFolder'] . urlencode($record[5]); ?>" data-lightbox="blogs-photo"><img src="thumbnail.php?i=<?php echo urlencode($record[5]); ?>&t=blogs&f=photo&v=tv" class="img-thumbnail"></a></td>
